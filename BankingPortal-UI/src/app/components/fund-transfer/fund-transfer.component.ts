  ...
  onSubmit(): void {
    if (this.fundTransferForm?.valid) {
      ...
      if (amount !== null && pin !== null && targetAccountNumber !== null) {
        this.loader.show('Transfiriendo fondos...'); // Show the loader before making the API call
        this.apiService
          ...
          .subscribe({
            next: (response: any) => {
              ...
              console.log('Fondos transferidos con éxito!', response);
            },
            error: (error: any) => {
              ...
              console.error('Transferencia de fondos fallida:', error);
            },
          });
      }
    }
