...
export class DonwloadtransactionsComponent {
  ...
  exportToExcel() {
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Transacciones'); // 'Transactions' is the sheet name

    // Save the workbook as an Excel file
    XLSX.writeFile(wb, 'historial_transacciones.xlsx'); // 'transactions.xlsx' is the file name
  }
